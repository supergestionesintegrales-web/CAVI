        ...
        >
          ...
          <div className="flex items-center justify-between pb-3 border-b border-[#222a3d]">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-[#0088ff]">qr_code_scanner</span>
          ...
          <div className="grid grid-cols-2 gap-1.5 p-1 bg-[#060e20] rounded-xl my-4 text-xs font-semibold">
            <button
              ...
              className={`py-2 rounded-lg flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                scanMode === 'qr'
                  ? 'bg-[#0088ff] text-white shadow shadow-[#0088ff]/30'
          ...
          {/* Scanner Viewport */}
          <div className="relative aspect-square w-full rounded-xl bg-[#060e20] border-2 border-dashed border-[#0088ff]/40 overflow-hidden flex flex-col items-center justify-center p-4">
            {scanMode === 'qr' ? (
              <>
                <div className="absolute inset-x-8 top-10 bottom-10 border border-[#0088ff]/70 rounded-lg pointer-events-none">
                  {/* Scanner line animation */}
                  <motion.div
                    animate={{ y: [0, 160, 0] }}
                    transition={{ repeat: Infinity, duration: 2.2, ease: 'easeInOut' }}
                    className="w-full h-0.5 bg-gradient-to-r from-transparent via-[#0088ff] to-transparent shadow-[0_0_8px_#0088ff]"
                  />
                </div>
            ...
            {isProcessing && (
              <div className="absolute inset-0 bg-[#060e20]/90 flex flex-col items-center justify-center gap-2 z-20">
                <span className="material-symbols-outlined text-[#0088ff] text-[28px] animate-spin">
                  sync
                </span>
                <span className="text-xs font-semibold text-[#0088ff]">Validando geocerca...</span>
              </div>
            )}
          </div>
          ...
          {!detectedPoint ? (
            <div className="mt-3 space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-1.5">
                ...
                >
                  <span className="font-bold text-[#0088ff] block">CM-108</span>
            ...
            <motion.div
              ...
              className="mt-4 p-3 bg-[#171f33] rounded-xl border border-[#0088ff]/40 flex flex-col gap-2"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-[#0088ff] flex items-center gap-1">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-lg bg-[#0088ff] hover:bg-[#0070d8] text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-md shadow-[#0088ff]/20 active:scale-95 transition-all mt-1 cursor-pointer"
              >
